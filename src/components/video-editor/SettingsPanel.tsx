...
export function SettingsPanel({
	...
	return (
		<div className="flex-[2] min-w-0 bg-[#17110f] border border-white/5 rounded-2xl flex flex-col shadow-xl h-full overflow-hidden">
			<div className="flex-1 overflow-y-auto custom-scrollbar p-4 pb-0">
					...
					<div className="flex items-center justify-between mb-3">
						...
						<div className="flex items-center gap-2">
							{zoomEnabled && selectedZoomDepth && (
								<span className="text-[10px] uppercase tracking-wider font-medium text-[#FF6738] bg-[#FF6738]/10 px-2 py-0.5 rounded-full">
							...
							return (
								<Button
									...
									className={cn(
										...
										isActive
											? "border-[#FF6738] bg-[#FF6738] text-white shadow-[#FF6738]/20"
				...
				>
					{hasWebcam && (
						...
						>
							<AccordionTrigger className="py-2.5 hover:no-underline">
								<div className="flex items-center gap-2">
									<Sparkles className="w-4 h-4 text-[#FF6738]" />
												...
												<button
													...
													className={cn(
														...
														webcamMaskShape === shape.value
															? "bg-[#FF6738] border-[#FF6738] text-white"
							...
							<div className="grid grid-cols-2 gap-2 mb-3">
								<div className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
									...
									<Switch
										...
										className="data-[state=checked]:bg-[#FF6738] scale-90"
									/>
								</div>
							</div>
							...
							<div className="grid grid-cols-2 gap-2">
								<div className="p-2 rounded-lg bg-white/5 border border-white/5">
									...
									<Slider
										...
										max={1}
										step={0.01}
										className="w-full [&_[role=slider]]:bg-[#FF6738] [&_[role=slider]]:border-[#FF6738] [&_[role=slider]]:h-3 [&_[role=slider]]:w-3"
									/>
								</div>
								<div className="p-2 rounded-lg bg-white/5 border border-white/5">
									<div className="flex items-center justify-between mb-1">
					...
					>
						<AccordionTrigger className="py-2.5 hover:no-underline">
							<div className="flex items-center gap-2">
								<Palette className="w-4 h-4 text-[#FF6738]" />
						...
						<AccordionContent className="pb-3">
							<Tabs defaultValue="image" className="w-full">
								<TabsList className="mb-2 bg-white/5 border border-white/5 p-0.5 w-full grid grid-cols-3 rounded-lg">
									<TabsTrigger
										value="image"
										className="data-[state=active]:bg-[#FF6738] data-[state=active]:text-white text-slate-400 text-[10px] py-1 rounded-md transition-all"
									>
										{t("background.image")}
									</TabsTrigger>
									<TabsTrigger
								...
								<div className="max-h-[min(200px,25vh)] overflow-y-auto custom-scrollbar">
									<TabsContent value="image" className="mt-0 space-y-2">
										...
										<Button
											...
											variant="outline"
											className="w-full gap-2 bg-white/5 text-slate-200 border-white/10 hover:bg-[#FF6738] hover:text-white hover:border-[#FF6738] transition-all h-7 text-[10px]"
										>
												...
												return (
													<div
														...
														className={cn(
															...
															isSelected
																? "border-[#FF6738] ring-1 ring-[#FF6738]/30"
																: "border-white/10 hover:border-[#FF6738]/40 opacity-80 hover:opacity-100 bg-white/5",
														)}
														style={{
			...
			{showCropModal && cropRegion && onCropChange && (
				<>
					...
					/>
					<div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[60] bg-[#17110f] rounded-2xl shadow-2xl border border-white/10 p-8 w-[90vw] max-w-5xl max-h-[90vh] overflow-auto animate-in zoom-in-95 duration-200">
						...
						<div className="mt-6 space-y-4">
								...
								{[
									...
									<div key={field} className="flex flex-col gap-1">
										...
										<input
											...
											className="w-[90px] h-8 rounded-md border border-white/10 bg-white/5 px-2 text-xs text-slate-200 outline-none focus:border-[#FF6738]/50 focus:ring-1 focus:ring-[#FF6738]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
										/>
									</div>
								))}
								...
								<div className="flex flex-col gap-1">
									...
									<div className="flex items-center gap-1.5">
										<select
											...
											className="h-8 rounded-md border border-white/10 bg-[#241917] px-2 text-xs text-slate-200 outline-none focus:border-[#FF6738]/50 cursor-pointer"
										>
											<option value="" className="bg-[#241917] text-slate-200">
												{t("crop.free")}
											</option>
											<option value="16:9" className="bg-[#241917] text-slate-200">
												16:9
											</option>
											<option value="9:16" className="bg-[#241917] text-slate-200">
												9:16
											</option>
											<option value="4:3" className="bg-[#241917] text-slate-200">
												4:3
											</option>
											<option value="3:4" className="bg-[#241917] text-slate-200">
												3:4
											</option>
											<option value="1:1" className="bg-[#241917] text-slate-200">
												1:1
											</option>
											<option value="21:9" className="bg-[#241917] text-slate-200">
												21:9
											</option>
										</select>
										<button
											...
											className={cn(
												...
												cropAspectLocked
													? "border-[#FF6738]/50 bg-[#FF6738]/10 text-[#FF6738]"
							...
							<div className="flex justify-end">
								<Button
									...
									size="lg"
									className="bg-[#FF6738] hover:bg-[#FF6738]/90 text-white"
								>
									{t("crop.done")}
								</Button>
							</div>
			...
			<div className="flex-shrink-0 p-4 pt-3 border-t border-white/5 bg-[#17110f]">
				<div className="flex items-center gap-2 mb-3">
					<button
						...
						className={cn(
							...
							exportFormat === "mp4"
								? "bg-[#FF6738]/10 border-[#FF6738]/50 text-white"
						...
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center gap-2">
								...
								<Switch
									...
									className="data-[state=checked]:bg-[#FF6738] scale-75"
								/>
							</div>
						</div>
					</div>
				...
				<Button
					...
					size="lg"
					onClick={onExport}
					className="w-full py-5 text-sm font-semibold flex items-center justify-center gap-2 bg-[#FF6738] text-white rounded-xl shadow-lg shadow-[#FF6738]/20 hover:bg-[#FF6738]/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200"
				>
					<Download className="w-4 h-4" />
